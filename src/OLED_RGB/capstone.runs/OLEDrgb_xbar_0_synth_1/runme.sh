...
HD_PWD='C:/Users/Student/Downloads/capstone-master/capstone-master/capstone/OLED_RGB/capstone.runs/OLEDrgb_xbar_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log OLEDrgb_xbar_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source OLEDrgb_xbar_0.tcl
