...
HD_PWD='C:/Users/Leo/Desktop/Engineering/capstone/capstone-master/capstone-master/capstone/OLED_RGB/capstone.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log OLEDrgb_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source OLEDrgb_wrapper.tcl
