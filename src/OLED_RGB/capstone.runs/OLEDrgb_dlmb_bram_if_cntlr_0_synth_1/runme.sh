...
HD_PWD='C:/Users/Student/Downloads/capstone-master/capstone-master/capstone/OLED_RGB/capstone.runs/OLEDrgb_dlmb_bram_if_cntlr_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log OLEDrgb_dlmb_bram_if_cntlr_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source OLEDrgb_dlmb_bram_if_cntlr_0.tcl
