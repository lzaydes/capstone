...
HD_PWD='C:/Users/Leo/Desktop/Engineering/capstone/capstone-master/capstone-master/capstone/OLED_RGB/capstone.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log OLEDrgb_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source OLEDrgb_wrapper.tcl -notrace
