...
HD_PWD='C:/Users/Leo/Desktop/Engineering/capstone/capstone/OLED2/OLED2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log OLED2_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source OLED2_wrapper.tcl -notrace
