...
HD_PWD='C:/Users/Student/Desktop/152B_Labs_Turner_Liu/capstone/capstone.runs/OLEDrgb_lmb_bram_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log OLEDrgb_lmb_bram_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source OLEDrgb_lmb_bram_0.tcl
