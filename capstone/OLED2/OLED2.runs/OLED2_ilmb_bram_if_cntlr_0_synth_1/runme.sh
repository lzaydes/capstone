...
HD_PWD='C:/Users/Student/Downloads/OLED2/OLED2.runs/OLED2_ilmb_bram_if_cntlr_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log OLED2_ilmb_bram_if_cntlr_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source OLED2_ilmb_bram_if_cntlr_0.tcl
