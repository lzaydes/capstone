...
HD_PWD='C:/Users/Leo/Desktop/Engineering/capstone/capstone/OLED2/OLED2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log OLED2_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source OLED2_wrapper.tcl
