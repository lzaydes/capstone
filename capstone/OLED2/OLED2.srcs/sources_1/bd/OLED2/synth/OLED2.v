...
//Date        : Mon Jun  3 14:56:58 2024
//Host        : CS152B-03 running 64-bit major release  (build 9200)
//Command     : generate_target OLED2.bd
//Design      : OLED2
//Purpose     : IP block netlist
//--------------------------------------------------------------------------------
`timescale 1 ps / 1 ps

(* CORE_GENERATION_INFO = "OLED2,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=OLED2,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=21,numReposBlks=14,numNonXlnxBlks=2,numHierBlks=7,maxHierDepth=1,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=USER,da_axi4_cnt=4,da_board_cnt=3,da_mb_cnt=1,synth_mode=OOC_per_IP}" *) (* HW_HANDOFF = "OLED2.hwdef" *) 
module OLED2
  ...
  (* X_INTERFACE_INFO = "xilinx.com:signal:clock:1.0 CLK.SYS_CLOCK CLK" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME CLK.SYS_CLOCK, CLK_DOMAIN OLED2_sys_clock, FREQ_HZ 100000000, PHASE 0.000" *) input sys_clock;
  ...
  OLED2_axi_uartlite_0_0 axi_uartlite_0
  ...
  (* BMM_INFO_PROCESSOR = "microblaze-le > OLED2 microblaze_0_local_memory/dlmb_bram_if_cntlr" *) 
  (* KEEP_HIERARCHY = "yes" *) 
  OLED2_microblaze_0_0 microblaze_0
  ...
  OLED2_microblaze_0_axi_periph_0 microblaze_0_axi_periph
  ...
  microblaze_0_local_memory_imp_1TZ43XG microblaze_0_local_memory
  ...
  OLED2_rst_clk_wiz_1_100M_0 rst_clk_wiz_1_100M
       (.aux_reset_in(1'b1),
...
module OLED2_microblaze_0_axi_periph_0
   (ACLK,
    ARESETN,
    M00_ACLK,
    M00_ARESETN,
  ...
  m00_couplers_imp_KJBEL2 m00_couplers
       (.M_ACLK(M00_ACLK_1),
  ...
  m01_couplers_imp_1VOY0E6 m01_couplers
       (.M_ACLK(M01_ACLK_1),
  ...
  m02_couplers_imp_1QUNHTZ m02_couplers
       (.M_ACLK(M02_ACLK_1),
  ...
  m03_couplers_imp_PDWT0V m03_couplers
       (.M_ACLK(M03_ACLK_1),
  ...
  s00_couplers_imp_7WB33X s00_couplers
...
module m00_couplers_imp_KJBEL2
   (M_ACLK,
    M_ARESETN,
    M_AXI_araddr,
    M_AXI_arready,
...
module m01_couplers_imp_1VOY0E6
   (M_ACLK,
    M_ARESETN,
    M_AXI_araddr,
    M_AXI_arready,
...
module m02_couplers_imp_1QUNHTZ
   (M_ACLK,
    M_ARESETN,
    M_AXI_araddr,
    M_AXI_arready,
...
module m03_couplers_imp_PDWT0V
   (M_ACLK,
    M_ARESETN,
    M_AXI_araddr,
    M_AXI_arready,
...
module microblaze_0_local_memory_imp_1TZ43XG
   (DLMB_abus,
    DLMB_addrstrobe,
    DLMB_be,
    DLMB_ce,
  ...
  (* BMM_INFO_ADDRESS_SPACE = "byte  0x00000000 32 > OLED2 microblaze_0_local_memory/lmb_bram" *) 
  (* KEEP_HIERARCHY = "yes" *) 
  OLED2_dlmb_bram_if_cntlr_0 dlmb_bram_if_cntlr
  ...
  OLED2_dlmb_v10_0 dlmb_v10
       (.LMB_ABus(microblaze_0_dlmb_bus_ABUS),
        ...
        .Sl_UE(microblaze_0_dlmb_bus_UE),
        .Sl_Wait(microblaze_0_dlmb_bus_WAIT));
  OLED2_ilmb_bram_if_cntlr_0 ilmb_bram_if_cntlr
...
module s00_couplers_imp_7WB33X
   (M_ACLK,
    M_ARESETN,
    M_AXI_araddr,
    M_AXI_arprot,
